    ...
    <div className="space-y-6" id="sams_fees_module" dir="rtl">
      ...
      {activeTab === 'subscriptions' && (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-sky-50 via-slate-50 to-indigo-50/60 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border border-sky-100 dark:border-slate-800 p-4 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 shadow-3xs">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5 text-right">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400 font-sans">
                  ...
                  {bgServiceStats && (
                    <span className="mr-1 text-slate-700 dark:text-slate-300 font-semibold">
                          ...
                          {isPaidThisMonth ? (
                            <div className="flex justify-end gap-1.5">
                              <button
                                ...
                                className="px-2 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 rounded-lg font-bold flex items-center gap-1 text-[11px] transition-colors cursor-pointer"
        ...
        {showWhatsAppModal && whatsAppStudent && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in" dir="rtl">
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-2xl max-w-lg w-full p-6 text-right space-y-4"
            >
              {/* Header */}
              <div className="flex items-center justify-between border-b border-gray-100 dark:border-slate-800 pb-3">
                ...
                <button
                  ...
                  className="p-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 rounded-lg cursor-pointer text-sm font-bold"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="bg-emerald-50/60 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-800/40 rounded-xl p-3 grid grid-cols-2 gap-2 text-xs font-sans">
                <div>
                  ...
                  <strong className="text-slate-800 dark:text-slate-200">{whatsAppStudent.name}</strong>
                </div>
                <div>
                  <span className="text-slate-400 block text-[10px]">اسم ولي الأمر:</span>
                  <strong className="text-slate-800 dark:text-slate-200">{whatsAppStudent.parent_name || 'غير مسجل'}</strong>
                </div>
                <div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full text-xs font-sans p-3 border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-100 focus:bg-white focus:outline-hidden leading-relaxed"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 border-t border-gray-100 dark:border-slate-800 pt-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() => setShowWhatsAppModal(false)}
                    className="px-3.5 py-2 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer"
                  >
                    إلغاء
                  </button>
